...
export const LogoIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M50 0L95.11 25V75L50 100L4.89 75V25L50 0Z" fillOpacity="0.2"/>
    <path d="M50 15L84.64 35V65L50 85L15.36 65V35L50 15Z" />
  </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path d="M12 14.25c-3.142 0-6 1.15-6 3v.75c0 .414.336.75.75.75h10.5c.414 0 .75-.336.75-.75v-.75c0-1.85-2.858-3-6-3Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25c-3.142 0-6 1.15-6 3v.75c0 .414.336.75.75.75h10.5c.414 0 .75-.336.75-.75v-.75c0-1.85-2.858-3-6-3Zm0 0V7.5M6.16 9.423c.39.39 1.023.39 1.414 0l.471-.471a.75.75 0 1 0-1.06-1.06l-.472.471a1.023 1.023 0 0 0 0 1.414Zm9.262 0c.39.39 1.023.39 1.414 0l.471-.471a.75.75 0 1 0-1.06-1.06l-.472.471a1.023 1.023 0 0 0 0 1.414Z" />
        <path d="M3.75 13.5c0-1.036.84-1.875 1.875-1.875h12.75c1.035 0 1.875.84 1.875 1.875v.375c0 .621-.504 1.125-1.125 1.125H4.875A1.125 1.125 0 0 1 3.75 13.875v-.375Z" />
    </svg>
);
